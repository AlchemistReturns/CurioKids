...
const styles = StyleSheet.create({
  ...
  balloon: {
    ...
    borderBottomLeftRadius: 65, borderBottomRightRadius: 65,
  ...
  string: {
    width: 2, height: 50, backgroundColor: '#ccc', alignSelf: 'center', marginTop: -2, zIndex: -1
  },
  text: { fontSize: 48, fontWeight: 'bold', color: 'white', textShadowColor: 'rgba(0,0,0,0.2)', textShadowRadius: 2 }
});