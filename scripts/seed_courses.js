...
async function seed() {
    ...
    for (const course of courses) {
        ...
        // 2. Delete all existing modules for this course to prevent duplicates
        ...
        for (const moduleDoc of existingModulesSnapshot.docs) {
            ...
            for (const lessonDoc of lessonsSnapshot.docs) {
                await deleteDoc(doc(firestore, "courses", course.id, "modules", moduleDoc.id, "lessons", lessonDoc.id));
            }
            // Delete the module
            await deleteDoc(doc(firestore, "courses", course.id, "modules", moduleDoc.id));
        }
